...
module "network" {
 ...
 module "database" {
     ...
     vpc_sn_az1_priv2_id   = "${module.network.vpc_sn_az1_priv2_id}"
     vpc_sn_az2_priv2_id   = "${module.network.vpc_sn_az2_priv2_id}"
 ...
 module "compute" {
     ...
     vpc_sn_pub_az1_id        = "${module.network.vpc_sn_az1_pub_id}"
     vpc_sn_pub_az2_id        = "${module.network.vpc_sn_az2_pub_id}"
